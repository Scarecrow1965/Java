 ...
 */
	...
	// Part 1. Define class TransactionRecord.
	// Objects of this class contain an account number and amount for the transaction.
	// Provide methods to modify and retrieve these values.

public class TransactionRecord extends Account
{
	// initializing variables
	// String firstName; // already incorporated into Account.class
	// String lastName; // already incorporated into Account.class
	// int accountNumber; // already incorporated into Account.class
	// double balance; // already incorporated into Account.class
	private double transaction;
	private int accountNumber; // this will be used if the Account accountNumber does not work
	...
	// set account number // this will be used if the Account accountNumber does not work
	public void setAccountNumber(int accountNumber)
	{
		this.accountNumber = accountNumber;
	}
	
	// get account number // this will be used if the Account accountNumber does not work
